...
\begin{verbatim}
    ...
    nn.Conv2d(3, 3, 1)
\end{verbatim}
where \tc{purple}{the last convolution layer is $0$ initialized. The secret decoder is implemented as a ResNet-50 with the standard ImageNet head replaced by an MLP to $\R^{50}$ of logits representing the decoded message. I loaded ImageNet weights into the ResNet for training.}
